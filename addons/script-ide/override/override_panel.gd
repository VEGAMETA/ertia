...
func count_selection(selected:bool) -> void:
	selections += 1 if selected else -1 
...
func collect_class_functions(native_class:StringName, existing_funcs:Dictionary[String, int]) -> PackedStringArray:
